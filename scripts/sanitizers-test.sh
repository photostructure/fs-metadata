...
export ASAN_OPTIONS="detect_leaks=1:print_stats=1:check_initialization_order=1:strict_init_order=1:print_module_map=1"
...
set +e
env -u LD_PRELOAD -u ASAN_OPTIONS -u LSAN_OPTIONS \
...
if [[ "$EXIT_CODE" -eq 0 ]]; then
    echo -e "${GREEN}\n✓ AddressSanitizer and LeakSanitizer tests passed${NC}"
else
